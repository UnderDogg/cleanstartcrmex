    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>
                        ...
                        <code class="highlighter-rouge">.h6</code> classes are also available, for when you want to
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>Traditional heading elements are designed to work best in the meat of your page content.
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>Align terms and descriptions horizontally by using our grid system’s predefined classes (or
                        ...
                        <code class="highlighter-rouge">.text-truncate</code> class to truncate the text with an
                        ellipsis.</p>
                    <div class="bd-example">
                        <dl class="row">
